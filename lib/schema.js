  ...
  properties: {
    ...
    topics: {
      ...
      items: {
        ...
        properties: {
          topic: { type: 'string' },
          dlq: { anyOf: [{ type: 'boolean' }, { type: 'string', default: defaultDlqTopic }] },
          url: { type: 'string' },
...
schema.$id = `https://schemas.platformatic.dev/@platformatic/kafka-hooks/${packageJson.version}.json`
schema.title = 'Platformatic kafka-hooks configuration'
schema.version = packageJson.version
schema.properties.kafka = kafka
